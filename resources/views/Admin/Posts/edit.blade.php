        ...
        <div class="row">
            ...
            <div class="col-lg-4">
                ...
                <div class="card mt-3">
                    ...
                    <div class="card-body">
                        <input type="text" name="new_tags[]" data-role="tagsinput" value="{{ $data->t }}">
                    </div>
                </div>
...
@section('script-libs')
    ...
    <!-- Place the first <script>
        ...
        script src =
            "https://cdn.tiny.cloud/1/v0sppfpond2fherytdggptl851wb7938ns7t8ctc4fj233v0/tinymce/7/tinymce.min.js"
