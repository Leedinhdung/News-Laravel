                        ...
                        <article class="card">
                            ...
                            <div class="card-body">
                                <h3 class="h4 mb-3"><a class="post-title"
                                                       href="{{route('detail-post',['id'=>$latestPost->id,'slug'=>$latestPost->slug])}}">  {{$latestPost->title}}
                                    </a></h3>
                                <ul class="card-meta list-inline">
                                    <li class="list-inline-item">
                                        <a href="author-single.html" class="card-meta-author">
                                            @php
                                                $url =\Illuminate\Support\Facades\Storage::url($latestPost->user->thumbnail);
                                            @endphp
                                            <img src="{{ $url }}" alt="">
                                            <span>{{$latestPost->user->first_name}} {{$latestPost->user->last_name}}</span>
                                        </a>
                                    </li>
                        ...
                        <article class="card mb-4">
                            ...
                            <div class="card-body">
                                <h3 class="mb-3"><a class="post-title"
                                                    href="{{ route('detail-post', ['id' => $item->id, 'slug' => $item->slug]) }}">{{ $item->title }}</a>
                                </h3>
                                <ul class="card-meta list-inline">
                                    <li class="list-inline-item">
                                        <a href="author-single.html" class="card-meta-author">
