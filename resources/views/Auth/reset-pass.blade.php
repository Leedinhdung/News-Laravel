                            ...
                            <div class="row justify-content-center g-0">
                                ...
                                <div class="col-lg-6">
                                    <div class="p-lg-5 p-4">
                                        ...
                                        <p class="text-muted">Tạo mật khẩu mới vui lòng không tạo mật khẩu đã sử dụng
                                        </p>

                                        <div class="p-2">
                                            <form action="{{ route('changePassword', ['token' => $token]) }}"
                                                method="POST">
                                                @csrf
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <div class="position-relative auth-pass-inputgroup">
                                                        <input type="password" class="form-control pe-5 password-input"
                                                            onpaste="return false" placeholder="Mật khẩu"
                                                ...
                                                <div class="mb-3">
                                                    <label class="form-label" for="confirm-password-input">Xác nhận mật
                                                        khẩu</label>
                                                ...
                                                <div class="mt-4">
                                                    <button class="btn btn-success w-100" type="submit">Đổi mật khẩu
                                                    </button>
                                                </div>
