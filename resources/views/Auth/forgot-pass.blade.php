                        ...
                        <div class="row justify-content-center g-0">
                            ...
                            <div class="col-lg-6">
                                <div class="p-lg-5 p-4">
                                    ...
                                    <p class="text-muted">Lấy lại mật khẩu </p>
                                    ...
                                    <div class="p-2">
                                        <form action="{{route('checkForgotPassword')}}" method="POST">
                                            ...
                                            <div class="text-center mt-4">
                                                <button class="btn btn-success w-100" type="submit">Gửi
                                                </button>
                                            </div>
                                        </form><!-- end form -->
                                    </div>
                                    ...
                                    <div class="mt-5 text-center">
                                        <p class="mb-0">Nếu bạn đã nhớ mật khẩu ! <a
                                                href="{{route('login')}}"
                ...
                <div class="col-lg-12">
                    <div class="text-center">
                        <p class="mb-0">&copy;
                            ...
                            Velzon. Crafted with <i class="mdi mdi-heart text-danger"></i>
                            by Themesbrand
                        </p>
                    </div>
                </div>
