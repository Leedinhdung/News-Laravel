...
Route::middleware('is_user')->prefix('admin')->as('admin.')->group(function () {
    ...
    Route::prefix('catalogues')->as('catalogues.')->group(function () {
        Route::get('/', [CatalogueController::class, 'index'])->name('index')->can('catalogue.list');
        Route::get('/trash', [CatalogueController::class, 'trash'])->name('trash');
        Route::get('/create', [CatalogueController::class, 'create'])->name('create')->can('catalogue.add');
        Route::post('/create', [CatalogueController::class, 'store'])->name('store');
        Route::get('{id}/edit', [CatalogueController::class, 'edit'])->name('edit')->can('catalogue.edit');
        Route::put('{id}/update', [CatalogueController::class, 'update'])->name('update');
        Route::get('{id}/delsoft', [CatalogueController::class, 'delSoft'])->name('delsoft')->can('catalogue.delsoft');
        Route::get('{id}/restore', [CatalogueController::class, 'restore'])->name('restore')->can('catalogue.restore');
        Route::get('{id}/delete', [CatalogueController::class, 'destroy'])->name('destroy')->can('catalogue.delete');
    });
    ...
    Route::prefix('role')->as('role.')->group(function () {
        Route::get('/', [RoleController::class, 'index'])->name('index')->can('role.list');
        ...
        Route::get('{id}/edit', [RoleController::class, 'edit'])->name('edit')->can('role.edit');
        ...
        Route::get('{id}/delete', [RoleController::class, 'destroy'])->name('destroy')->can('role.delete');
    });
    Route::prefix('permission')->as('permission.')->group(function () {

        // Route::get('/trash', [PostController::class, 'trash'])->name('trash');
        Route::get('/create', [PermissionController::class, 'create'])->name('create')->can('permission.add');
        Route::post('/create', [PermissionController::class, 'store'])->name('store');
        // Route::get('{id}/show', [RoleController::class, 'show'])->name('show');
        Route::get('{id}/edit', [PermissionController::class, 'edit'])->name('edit')->can('permission.edit');
        Route::post('{id}/update', [PermissionController::class, 'update'])->name('update');
        Route::get('{id}/delete', [PermissionController::class, 'destroy'])->name('destroy')->can('permission.delete');
    });
});
